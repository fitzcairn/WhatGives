...
function CreateFrame()
   ...
   -- Return a table with emulated frame functonality.
   -- Since we're not going to test WoW-specific UI functions,
   -- go ahead and assign the methods to the null function.
   return {
      RegisterEvent = nullfunc,
      SetScript     = nullfunc,
	  }
end
